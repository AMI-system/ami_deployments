...
df = pd.read_csv(r'./files/bci_ami_deployments.csv')
...
geojson_file = r"./geojson_files/panama.geojson"
panama_geojson = folium.GeoJson(geojson_file)
panama_geojson.add_to(map_panama)

# Save the map as an HTML file
map_panama.save('index_bci.html')
